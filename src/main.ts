...
async function main() {
  ...
  const controls = {
    up: or(gamepad.button(ControlMap.Up), keyboard.key(ControlMap.Up)),
    down: or(gamepad.button(ControlMap.Down), keyboard.key(ControlMap.Down)),
    left: or(gamepad.button(ControlMap.Left), keyboard.key(ControlMap.Left)),
    right: or(gamepad.button(ControlMap.Right), keyboard.key(ControlMap.Right)),
  };
